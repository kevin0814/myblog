...
//	Id          int
//	Age         int16
//	UserTest    *UserTest   `orm:"reverse(one)"` // Reverse relationship (optional)
//}
...
func InitMysql() {
	...
	//dbConn := "root:root@tcp(127.0.0.1:3306)/beego?charset=utf8"
	dbConn := user + ":" + pwd + "@tcp(" + host + ":" + port + ")/" + dbname + "?charset=utf8"
	orm.RegisterDataBase("default", "mysql", dbConn)
	//orm.RegisterDataBase("test", "mysql", "test:yrv1+LtyRjLUb7QbVSlxXlxjcJ8=@tcp(192.168.0.252:3310)/nt_amazon_listing?parseTime=True&loc=Local&charset=utf8")
